    ...
    return (
        <div>
            ...
            <div className="row">
                ...
                <div className="d-flex w-100 col-md-9 mx-auto headerData" style={{background: '#000'}}>
                        <p className="text-light col-md-2 ml-5">Name</p>
                        <p className="text-light col-md-2 ml-5">Email ID</p>
                        <p className="text-light col-md-1 mx-5">Registering date</p>
                        <p className="text-light col-md-3 ml-5">HomeContent list</p>
                        <p className="text-light col-md-1">Action</p>
                    </div>
                    {
